...
[`@aws-sdk/client-bedrock-agent-runtime`](https://www.npmjs.com/package/@aws-sdk/client-bedrock-agent-runtime/v/3.1044.0).
...
- @aws-sdk/client-bedrock-agent-runtime v3.1044.0 - [https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent-runtime&version=3.1044.0](https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent-runtime&version=3.1044.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1044.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z9P7XU2yMsqD0vOHxwAATmhRVn3QARcVi+khPwUsOII7uBcbdxdd6MgufmsxHVty
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bedrock-agent-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1044.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1044.0/index.min.mjs": "sha384-z9P7XU2yMsqD0vOHxwAATmhRVn3QARcVi+khPwUsOII7uBcbdxdd6MgufmsxHVty"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bedrock-agent-runtime/blob/refs/tags/3.1044.0/LICENSE
```
