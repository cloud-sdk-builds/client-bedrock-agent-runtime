...
[`@aws-sdk/client-bedrock-agent-runtime`](https://www.npmjs.com/package/@aws-sdk/client-bedrock-agent-runtime/v/3.1105.0).
...
- @aws-sdk/client-bedrock-agent-runtime v3.1105.0 - [https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent-runtime&version=3.1105.0](https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent-runtime&version=3.1105.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Nwf+Zkq79g4v5lX9vzOvENGoIaxqqBoETiOIYAIwJRxR20X7SAhp+VlLbOc8QdT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bedrock-agent-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent-runtime@3.1105.0/index.min.mjs": "sha384-8Nwf+Zkq79g4v5lX9vzOvENGoIaxqqBoETiOIYAIwJRxR20X7SAhp+VlLbOc8QdT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bedrock-agent-runtime/blob/refs/tags/3.1105.0/LICENSE
```
